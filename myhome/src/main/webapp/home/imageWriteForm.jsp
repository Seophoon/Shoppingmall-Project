		...
		<form:form action = "../image/write.html" method = "post" enctype = "multipart/form-data"
			...
			<table>
				...
				<tr>
					<th>내 용</th>
					<td>
						<form:textarea rows="8" cols="40" path="content"></form:textarea>
					</td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		function check(frm){
			...
			if(frm.password.value == ''){
				alert("암호를 입력하세요. 수정 및 삭제에 필요합니다.");
				frm.password.focus();
				return false;
			}else {
				if(frm.password.value.length > 20){
					alert("암호는 20자 이내로 작성하세요.");
					frm.password.focus();
					return false;
				}
			}
