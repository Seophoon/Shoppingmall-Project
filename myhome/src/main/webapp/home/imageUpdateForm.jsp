...
<body>
	<div align = "center">
		<form:form action = "../image/updateDo.html" method = "post" enctype="multipart/form-data"
			...
			<form:hidden path = "w_id" value = "${BBS.w_id }"/>
			<table width = "100%" border = "1">
				<tr>
					<th>글제목</th>
					<td>
						<form:input path = "title" size = "20" value = "${imageBBS.title }"/>
					</td>
				</tr>
				<tr>
					<th>작성자</th>
				...
				<tr>
					<th>글내용</th>
					<td>
						<form:textarea rows="4" cols="40" path = "content" value="${imageBBS.content }"></form:textarea>
					</td>
				</tr>
				<tr>
